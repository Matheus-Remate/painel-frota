-- Corrige a RPC de retirada imediata publicada pela 037: a tabela de
-- notificações usa recipient_user_id e exige o tipo da notificação.
...
BEGIN
  ...
  SELECT user_id, 'vehicle_checkout', 'Retirada imediata',
    format('%s retirou %s em modo de urgência.', trim(p_driver_name), vehicle_row.license_plate),
